...
class OpinionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create opinion" do
    assert_difference('Opinion.count') do
      post opinions_url, params: { opinion: { content: @opinion.content, title: @opinion.title, user_id: @opinion.user_id } }
    end

    assert_redirected_to opinion_path(Opinion.last)
  end
  ...
  test "should update opinion" do
    patch opinion_url(@opinion), params: { opinion: { content: @opinion.content, title: @opinion.title, user_id: @opinion.user_id } }
    assert_redirected_to opinion_path(@opinion)
  end
